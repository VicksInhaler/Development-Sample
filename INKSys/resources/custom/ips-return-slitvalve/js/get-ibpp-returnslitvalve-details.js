...
function GetIPSReturnSValve(callback) {
    $.ajax({
        url: "IPS_ReturnSValve.aspx/GetIPSReturnSValve",
        type: "POST",
        data: "{}",
        ...
        success: function (e) {
            ...
            MainTable = $(".return-slitvalve-table").DataTable({
                searching: true,
                paging: true,
                info: true,
                ordering: false,
...
function UpdateReturnSValve() {
    ...
    $.ajax({
        url: "IPS_ReturnSValve.aspx/UpdateIPSReturnSValve",
        type: "POST",
        data: JSON.stringify({
