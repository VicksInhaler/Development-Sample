<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Inksys.master" AutoEventWireup="true" CodeFile="IPS_ReturnSValve.aspx.cs" Inherits="Views_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <!--STYLES-->
    <link href="../resources/custom/ips-return-slitvalve/css/return-slitvalve.css" rel="stylesheet" />
    <!--SWEET ALERT CSS-->
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Return Slit Valve</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card card-purple pb-0">
                    <!--TITLE HEADER-->
                    <div class="card-header">
                        <h3 style="font-family: 'Comic Sans MS'">RETURN SLIT VALVE</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="return-slitvalve-table table table-bordered text-nowrap" style="width: 100%; border: 1px solid #000;">
                                    </table>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color:blueviolet;">
                        <h4 class="modal-title" style="color: white;">Edit Slit Valve Returns<label id="lbl_EditReturnSValve"></label></h4>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" Runat="Server">
    <!-- Get Return Slit Valve Data -->
    <script src="../resources/custom/ips-return-slitvalve/js/get-ibpp-returnslitvalve-details.js"></script>
    <!-- Notifications -->
    <script src="../resources/custom/ips-return-slitvalve/js/notification.js"></script>
    <!-- Validations -->
